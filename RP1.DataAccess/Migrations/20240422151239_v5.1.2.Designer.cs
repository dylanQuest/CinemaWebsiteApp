...
namespace RP1.DataAccess.Migrations
{
    ...
    [Migration("20240422151239_v5.1.2")]
    partial class v512
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RP1.DataAccess.DataAccess.AppDBContext+ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("RP1.DataAccess.DataAccess.AppDBContext+ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("RP1.DataAccess.DataAccess.AppDBContext+ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RP1.DataAccess.DataAccess.AppDBContext+ApplicationUser", null)
                        .WithMany()
